$(document).ready(function() {
	...
	$(".mc_item_wrapp ul").each(function(){
		$(this).after("<div class='mc_item_wrapp_af'></div>");
	});
	
	$(".mc_toggle").click(function(){
		if($(this).parent().parent().children("ul").is(":visible")){
			$(this).parent().parent().children("ul").slideUp();
			$(this).parent().parent().children(".mc_item_wrapp_af").hide();
		}else{
			$("body .mc_wrapp .mc_item_wrapp > ul, .mc_item_wrapp_af").hide();
			$(".mc_item_wrapp").removeClass("active");
			$(this).parent().parent().addClass("active");
			$(this).parent().parent().children("ul").slideDown();
			$(this).parent().parent().children(".mc_item_wrapp_af").show();
		}
